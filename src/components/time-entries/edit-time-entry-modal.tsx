  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      <DialogTitle sx={{ position: "relative" }}>
        Edit Time Entry
        <Fab size="small" color="default" aria-label="close" onClick={onClose} sx={{ position: "absolute", right: 16, top: 8 }}>
          <CloseIcon />
        </Fab>
      </DialogTitle>
      ...
      <DialogContent>
        <Box sx={{ display: "grid", gap: 2, mt: 1 }}>
          <TextField label="Minutes" type="number" value={minutes} onChange={(e) => setMinutes(e.target.value === "" ? "" : Number(e.target.value))} fullWidth />
