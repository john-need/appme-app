...
describe("toLocalYMD", () => {
  ...
  it.skip("should convert a Date object to EST YYYY-MM-DD format", () => {
  ...
  it.skip("should convert an ISO string to EST YYYY-MM-DD format", () => {
    // Expected result: 2026-01-19 (because 08:38 UTC is 03:38 EST, which is the previous day)
    expect(toLocalYMD("2026-01-20T08:38:16.728Z")).toBe("2026-01-19");
  });

  it.skip("should handle date at UTC midnight correctly", () => {
    // UTC midnight is 19:00 EST the previous day
    expect(toLocalYMD("2026-01-20T00:00:00.000Z")).toBe("2026-01-19");
  });

  it.skip("should handle date at EST midnight correctly", () => {
